...
export default function Navigation({ currentPage, onPageChange }) {
  const pages = [
    { key: 'simulations', label: 'Filter Simulations', description: 'Interactive particle flow animations' }
    // Hide CFD and Comparison pages for now - uncomment when ready:
    // { key: 'cfd', label: 'Advanced CFD', description: 'OpenFOAM streamline visualization' }
          ...
          <div style={{ 
            ...
            <div>
              <h1 style={{ 
                ...
                ViSTAT Filtration Visualization
              </h1>
              <p style={{ 
                margin: '5px 0 0 0', 
                fontSize: '14px', 
                ...
                Interactive Particle Flow Animations for Air Filtration Technology
              </p>
            </div>
          </div>
